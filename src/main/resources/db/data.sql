...
INSERT into MENU_ITEMS(date_create, RESTAURANT_ID, dish_id, price)
...
INSERT INTO users (name, email, password)
VALUES ('User', 'quest@yandex.ru', '{noop}quest'), --100018
...
INSERT INTO VOTES (date_create, RESTAURANT_ID, USER_ID)
VALUES (now, 100014, 100000),
       (now, 100014, 100001),
